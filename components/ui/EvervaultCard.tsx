...
export function CardPattern({ randomString }: any) {
  let maskImage = useMotionTemplate`radial-gradient( white, transparent)`;
  ...
  return (
    <div className="pointer-events-none">
      ...
      ></div>
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-green-500
          to-blue-700 backdrop-blur-xl transition duration-500
      ...
      >
        <p
          className="absolute inset-x-0 h-full whitespace-pre-wrap break-words
            font-mono text-xs font-bold text-white transition duration-500"
        >
          {randomString}
        </p>
      </motion.div>
