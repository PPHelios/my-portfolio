...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          `no-visible-scrollbar relative flex w-full max-w-full flex-row
          items-center justify-center overflow-auto [perspective:1000px]
          sm:overflow-visible`,
          containerClassName,
        )}
      >
        {propTabs.map((tab, idx) => (
          ...
          >
            ...
            <span
              className="relative block text-xs text-black dark:text-white
                sm:text-sm"
            >
              {tab.title}
            </span>
