  ...
  return (
    <button
      ...
      className="relative z-50 inline-flex h-12 w-full overflow-hidden
        rounded-lg p-px focus:outline-none"
    >
      <span
        className="animate-[spin_2s_linear_infinite] absolute inset-[-1000%]
          bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]"
      />
      <span
        className="inline-flex size-full cursor-pointer items-center
